...
This action installs the [A11yWatch CLI](https://github.com/A11yWatch/a11ywatch/tree/main/cli) onto your pipeline for usage throughout any job or step.

### Usage

```yaml
- uses: a11ywatch/github-action@v1.6.3
  with:
